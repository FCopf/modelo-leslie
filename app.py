...
v0_1 = st.sidebar.slider(f"Estado inicial de {grupos_etarios[0]}", min_value=0, max_value=500, value=100)
v0_2 = st.sidebar.slider(f"Estado inicial de {grupos_etarios[1]}", min_value=0, max_value=500, value=80)
v0_3 = st.sidebar.slider(f"Estado inicial de {grupos_etarios[2]}", min_value=0, max_value=500, value=30)
v0_4 = st.sidebar.slider(f"Estado inicial de {grupos_etarios[3]}", min_value=0, max_value=500, value=10)
